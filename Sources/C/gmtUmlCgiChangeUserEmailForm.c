...
main (int argc, char **argv)
{
  ...
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlChangeUserNameForm.cgi?gmtUmlLanguage=english&gmtUmlConfigurationFileName=%s\"><img src=\"../images/en-us.png\"> English</a>", gmtUmlConfigurationFileName);
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlChangeUserNameForm.cgi?gmtUmlLanguage=portuguese&gmtUmlConfigurationFileName=%s\"><img src=\"../images/pt-br.png\"> Portuguese</a>", gmtUmlConfigurationFileName);
  ...
  printf ("<h2>%s</h2>", GmtUmlGetWebUserInterface (gmtUmlWebChangeUserEmail, gmtUmlLanguage));
  printf ("<p>%s</p>", GmtUmlGetWebUserInterface (gmtUmlWebTextChangeUserEmail, gmtUmlLanguage));
  ...
  printf ("</div>");
  printf ("<div class=\"form-group mx-sm-3\">");
  printf ("<label for=\"inputEmail\" class=\"sr-only\">%sl</label>", GmtUmlGetWebUserInterface (gmtUmlInputNewEmail, gmtUmlLanguage));
  printf ("<input type=\"text\" class=\"form-control\" id=\"inputEmail\" placeholder=\"%s\">", GmtUmlGetWebUserInterface (gmtUmlInputNewEmail, gmtUmlLanguage));
  printf ("</div>");
  printf ("<button type=\"submit\" class=\"btn btn-primary\">%s</button>", GmtUmlGetWebUserInterface (gmtUmlWebChangeUserEmail, gmtUmlLanguage));
  printf ("</form>");
