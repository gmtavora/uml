...
main (int argc, char **argv)
{
  ...
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlUserPanel.cgi?gmtUmlLanguage=english&gmtUmlConfigurationFileName=%s\"><img src=\"/~gabriel.tavora/images/en-us.png\"> English</a>", gmtUmlConfigurationFileName);
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlUserPanel.cgi?gmtUmlLanguage=portuguese&gmtUmlConfigurationFileName=%s\"><img src=\"/~gabriel.tavora/images/pt-br.png\"> Portuguese</a>", gmtUmlConfigurationFileName);
  ...
  printf ("<button type=\"button\" class=\"btn btn-lg btn-primary btn-block btn-menu\" onclick=\"window.location.href='gmtUmlResetUserPassword.cgi?gmtUmlLanguage=%i&gmtUmlConfigurationFileName=%s';\">%s</button>", gmtUmlLanguage, gmtUmlConfigurationFileName, GmtUmlGetWebUserInterface (gmtUmlWebResetUserPassword, gmtUmlLanguage));
  printf ("<button type=\"button\" class=\"btn btn-lg btn-primary btn-block btn-menu\" onclick=\"window.location.href='gmtUmlChangePassword.cgi?gmtUmlLanguage=%i&gmtUmlConfigurationFileName=%s';\">%s</button>", gmtUmlLanguage, gmtUmlConfigurationFileName, GmtUmlGetWebUserInterface (gmtUmlWebChangeUserPassword, gmtUmlLanguage));
  printf ("<button type=\"button\" class=\"btn btn-lg btn-primary btn-block btn-menu\" onclick=\"window.location.href='gmtUmlChangeName.cgi?gmtUmlLanguage=%i&gmtUmlConfigurationFileName=%s';\">%s</button>", gmtUmlLanguage, gmtUmlConfigurationFileName, GmtUmlGetWebUserInterface (gmtUmlWebChangeUserName, gmtUmlLanguage));
  printf ("<button type=\"button\" class=\"btn btn-lg btn-primary btn-block btn-menu\" onclick=\"window.location.href='gmtUmlChangeEmail.cgi?gmtUmlLanguage=%i&gmtUmlConfigurationFileName=%s';\">%s</button>", gmtUmlLanguage, gmtUmlConfigurationFileName, GmtUmlGetWebUserInterface (gmtUmlWebChangeUserEmail, gmtUmlLanguage));
  printf ("<button type=\"button\" class=\"btn btn-lg btn-primary btn-block btn-menu\" onclick=\"window.location.href='gmtUmlGetUsers?gmtUmlLanguage=%i&gmtUmlConfigurationFileName=%s';\">%s</button>", gmtUmlLanguage, gmtUmlConfigurationFileName, GmtUmlGetWebUserInterface (gmtUmlWebGetUsers, gmtUmlLanguage));
  if (currentUser->profile < 4)
    printf ("<button type=\"button\" class=\"btn btn-lg btn-primary btn-block btn-menu\" onclick=\"window.location.href='gmtUmlAdminPanel.cgi?gmtUmlLanguage=%i&gmtUmlConfigurationFileName=%s';\">%s</button>", gmtUmlLanguage, gmtUmlConfigurationFileName, GmtUmlGetWebUserInterface (gmtUmlWebAdminsPanel, gmtUmlLanguage));
