...
main (int argc, char **argv)
{
  ...
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlAddUserForm.cgi?gmtUmlLanguage=english&gmtUmlConfigurationFileName=%s\"><img src=\"../images/en-us.png\"> English</a>", gmtUmlConfigurationFileName);
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlAddUserForm.cgi?gmtUmlLanguage=portuguese&gmtUmlConfigurationFileName=%s\"><img src=\"../images/pt-br.png\"> Portuguese</a>", gmtUmlConfigurationFileName);
  ...
  printf ("<div class=\"container\">");
	...
	printf ("<h2>Add user</h2>");
	printf ("<div class=\"alert alert-warning\" role=\"alert\">");
  printf ("%s", GmtUmlGetWebUserInterface (gmtUmlWebTextAddUser, gmtUmlLanguage));
	printf ("</div>");
  printf ("<form class=\"form-signin\" method=\"POST\" action=\"gmtUmlAddUser.cgi?gmtUmlConfigurationFileName=%s&gmtUmlLanguage=%s\">", gmtUmlConfigurationFileName, gmtUmlLanguageName);
	...
	printf ("<label for=\"inputPassword\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlPassword, gmtUmlLanguage));
	printf ("<input type=\"password\" class=\"form-control\" id=\"inputPassword\">");
	printf ("</div>");
	printf ("<div class=\"form-group col-md-4\">");
	printf ("<label for=\"inputPasswordConfirmation\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlPasswordConfirmation, gmtUmlLanguage));
	printf ("<input type=\"password\" class=\"form-control\" id=\"inputPasswordConfirmation\">");
	printf ("</div>");
	printf ("<div class=\"form-group col-md-4\">");
	...
	printf ("<button type=\"submit\" class=\"btn btn-primary btn-form\">%s</button>", GmtUmlGetWebUserInterface (gmtUmlWebAddUser, gmtUmlLanguage));
