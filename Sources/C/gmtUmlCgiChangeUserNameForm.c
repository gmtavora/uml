...
main (int argc, char **argv)
{
  ...
  printf ("<h2>%s</h2>", GmtUmlGetWebUserInterface (gmtUmlWebChangeUserName, gmtUmlLanguage));

  printf ("<p>%s</p>", GmtUmlGetWebUserInterface (gmtUmlWebTextChangeName, gmtUmlLanguage));
  ...
  printf ("</div>");
  printf ("<div class=\"form-group mx-sm-3\">");
  printf ("<label for=\"inputName\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlInputNewName, gmtUmlLanguage));
  printf ("<input type=\"text\" class=\"form-control\" id=\"inputName\" placeholder=\"%s\">", GmtUmlGetWebUserInterface (gmtUmlInputNewName, gmtUmlLanguage));
  printf ("</div>");
  printf ("<button type=\"submit\" class=\"btn btn-primary\">%s</button>", GmtUmlGetWebUserInterface (gmtUmlWebChangeUserName, gmtUmlLanguage));
  printf ("</form>");
