...
main (int argc, char **argv)
{
  ...
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlResetUserPasswordForm.cgi?gmtUmlLanguage=english&gmtUmlConfigurationFileName=%s\"><img src=\"images/en-us.png\"> English</a>", gmtUmlConfigurationFileName);
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlResetUserPasswordForm.cgi?gmtUmlLanguage=portuguese&gmtUmlConfigurationFileName=%s\"><img src=\"images/pt-br.png\"> Portuguese</a>", gmtUmlConfigurationFileName);
  ...
  printf ("<h2>%s</h2>", GmtUmlGetWebUserInterface (gmtUmlWebResetUserPassword, gmtUmlLanguage));
  printf ("<p>%s</p>", GmtUmlGetWebUserInterface (gmtUmlWebTextResetUserPassword, gmtUmlLanguage));
  ...
  printf ("</div>");
  printf ("<button type=\"submit\" class=\"btn btn-primary\">%s</button>", GmtUmlGetWebUserInterface (gmtUmlResetPassword, gmtUmlLanguage));
  printf ("</form>");
