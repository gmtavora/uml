...
main (int argc, char **argv)
{
  ...
  char gmtUmlNickname [GMT_UML_MAX_NICKNAME_LENGTH+1],
       ...
       gmtUmlFriendMail [GMT_UML_MAX_EMAIL_LENGTH+1],
       receivedValue [32+1],
       *validation;
  ...
  if (mlCgiGetFormStringNoNewLines ("inputFriendMail", gmtUmlFriendMail, GMT_UML_MAX_EMAIL_LENGTH + 1))
  {
    mlCgiEndHttpHeader ();
    printf ("<html>");
    printf ("<head>");
    printf ("<title>Error #%i</title>", gmtUmlErrorInvalidEmail);
    printf ("</head>");
    printf ("<body>");
    printf ("ERROR (#%i): %s.\n", gmtUmlErrorInvalidEmail, GmtUmlGetWebErrorMessage (gmtUmlErrorInvalidEmail, gmtUmlLanguage));
    printf ("</body>");
    printf ("</html>");
    free (configurationOptions);
    free (gmtUmlUserData);
  ...
  if ((gmtUmlValidation = GmtUmlRequestRegistration (configurationOptions, gmtUmlFriendMail, gmtUmlNewUserData)))
  {
    printf ("ERROR (#%i): %s.\n", gmtUmlValidation, GmtUmlGetCliErrorMessage (gmtUmlValidation, gmtUmlLanguage));
    return gmtUmlOk;
  }
  ...
  printf ("</head>");
  printf ("<body>Registration requested.</body>");
  printf ("</html>");
