...
main (int argc, char **argv)
{
  ...
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlChangeUserProfileForm.cgi?gmtUmlLanguage=english&gmtUmlConfigurationFileName=%s\"><img src=\"../images/en-us.png\"> English</a>", gmtUmlConfigurationFileName);
  printf ("<a class=\"dropdown-item\" href=\"gmtUmlChangeUserProfileForm.cgi?gmtUmlLanguage=portuguese&gmtUmlConfigurationFileName=%s\"><img src=\"../images/pt-br.png\"> Portuguese</a>", gmtUmlConfigurationFileName);
  ...
  printf ("<h2>%s</h2>", GmtUmlGetWebUserInterface (gmtUmlWebChangeUserProfile, gmtUmlLanguage));
  printf ("<p>%s</p>", GmtUmlGetWebUserInterface (gmtUmlWebTextChangeUserProfile, gmtUmlLanguage));
  ...
  printf ("</select>");
  printf ("</div>");
  printf ("<button type=\"submit\" class=\"btn btn-primary\">%s</button>", GmtUmlGetWebUserInterface (gmtUmlWebChangeUserProfile, gmtUmlLanguage));
  printf ("</form>");
