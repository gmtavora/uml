 ...
 * $Log: gmtUmlCgiShowRequestRegistrationForm.c,v $
...
printf ("	      			<a class=\"dropdown-item\" href=\"gmtUmlShowRequestRegistrationForm.cgi?gmtUmlLanguage=english&gmtUmlConfigurationFileName=%s\"><img src=\"/~gabriel.tavora/images/en-us.png\"> English</a>", gmtUmlConfigurationFileName);
printf ("      				<a class=\"dropdown-item\" href=\"gmtUmlShowRequestRegistrationForm.cgi?gmtUmlLanguage=portuguese&gmtUmlConfigurationFileName=%s\"><img src=\"/~gabriel.tavora/images/pt-br.png\"> Portuguese</a>", gmtUmlConfigurationFileName);
...
printf ("				<h2 class=\"form-signin-heading\">%s</h2>", GmtUmlGetWebUserInterface (gmtUmlRegister, gmtUmlLanguage));
printf ("				<label for=\"inputName\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlFullName, gmtUmlLanguage));
printf ("				<input type=\"text\" name=\"inputName\" id=\"inputName\" class=\"form-control\" placeholder=\"%s\" required autofocus>", GmtUmlGetWebUserInterface (gmtUmlFullName, gmtUmlLanguage));
printf ("				<label for=\"inputNameConfirmation\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlFullName, gmtUmlLanguage));
printf ("				<input type=\"text\" name=\"inputNameConfirmation\" id=\"inputNameConfirmation\" class=\"form-control\" placeholder=\"%s\" required>", GmtUmlGetWebUserInterface (gmtUmlNameConfirmation, gmtUmlLanguage));
printf ("				<label for=\"inputPassword\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlPassword, gmtUmlLanguage));
printf ("				<input type=\"password\" name=\"inputPassword\" id=\"inputPassword\" class=\"form-control\" placeholder=\"%s\" required>", GmtUmlGetWebUserInterface (gmtUmlPassword, gmtUmlLanguage));
printf ("				<label for=\"inputPasswordConfirmation\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlConfirmPassword, gmtUmlLanguage));
printf ("				<input type=\"password\" name=\"inputPasswordConfirmation\" id=\"inputPasswordConfirmation\" class=\"form-control\" placeholder=\"%s\" required>", GmtUmlGetWebUserInterface (gmtUmlConfirmPassword, gmtUmlLanguage));
printf ("				<label for=\"inputEmail\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlYourEmail, gmtUmlLanguage));
printf ("				<input type=\"email\" name=\"inputEmail\" id=\"inputEmail\" class=\"form-control\" placeholder=\"%s\" required>", GmtUmlGetWebUserInterface (gmtUmlEmail, gmtUmlLanguage));
printf ("				<label for=\"inputEmailConfirmation\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlConfirmYourEmail, gmtUmlLanguage));
printf ("				<input type=\"email\" name=\"inputEmailConfirmation\" id=\"inputEmailConfirmation\" class=\"form-control\" placeholder=\"%s\" required>", GmtUmlGetWebUserInterface (gmtUmlConfirmYourEmail, gmtUmlLanguage));
printf ("				<label for=\"inputFriendMail\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlFriendEmail, gmtUmlLanguage));
printf ("				<input type=\"email\" name=\"inputFriendEmail\" id=\"inputFriendEmail\" class=\"form-control\" placeholder=\"%s\" required>", GmtUmlGetWebUserInterface (gmtUmlFriendEmail, gmtUmlLanguage));
printf ("				<div class=\"checkbox\">");
printf ("					<label>");
printf ("						<input type=\"checkbox\" value=\"remember-me\" required> %s", GmtUmlGetWebUserInterface (gmtUmlAcceptTermsOfUse, gmtUmlLanguage));
printf ("					</label>");
printf ("				</div>");
...
printf ("				<button class=\"btn btn-lg btn-primary btn-block btn-signin\" type=\"submit\">%s</button>", GmtUmlGetWebUserInterface (gmtUmlRegister, gmtUmlLanguage));
printf ("			</form>");
printf ("			<a href=\"#\" class=\"forgot-password\">%s</a>", GmtUmlGetWebUserInterface (gmtUmlBack, gmtUmlLanguage));
printf ("		</div>");
printf ("	</div>");
...
/* $RCSfile: gmtUmlCgiShowRequestRegistrationForm.c,v $ */
