 ...
 * $Log: gmtUmlCgiShowRequestPasswordResetForm.c,v $
...
printf ("	      			<a class=\"dropdown-item\" href=\"gmtUmlShowRequestPasswordResetForm.cgi?gmtUmlLanguage=english&gmtUmlConfigurationFileName=%s\"><img src=\"/~gabriel.tavora/images/en-us.png\"> English</a>", gmtUmlConfigurationFileName);
printf ("      				<a class=\"dropdown-item\" href=\"gmtUmlShowRequestPasswordResetForm.cgi?gmtUmlLanguage=portuguese&gmtUmlConfigurationFileName=%s\"><img src=\"/~gabriel.tavora/images/pt-br.png\"> Portuguese</a>", gmtUmlConfigurationFileName);
...
printf ("			<form class=\"form-signin\" method=\"POST\" action=\"gmtUmlRequestPasswordReset.cgi\">");
...
printf ("				<input type=\"text\" name=\"inputNickname\" id=\"inputNickname\" class=\"form-control\" placeholder=\"%s\" required autofocus>", GmtUmlGetWebUserInterface (gmtUmlUsername, gmtUmlLanguage));
printf ("				<label for=\"inputEmail\" class=\"sr-only\">%s</label>", GmtUmlGetWebUserInterface (gmtUmlEmail, gmtUmlLanguage));
printf ("				<input type=\"email\" name=\"inputEmail\" id=\"inputEmail\" class=\"form-control\" placeholder=\"%s\" required autofocus>", GmtUmlGetWebUserInterface (gmtUmlEmail, gmtUmlLanguage));
...
/* $RCSfile: gmtUmlCgiShowRequestPasswordResetForm.c,v $ */
